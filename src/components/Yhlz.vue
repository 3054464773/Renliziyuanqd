...
<template >
  ...
  <div>
    ...
    <el-date-picker
        ...
        clearable
    />
    <el-button style="position: relative;right: -166px;" @click="mohuchaxunyghmdddd">查询</el-button>
    <el-input v-model="data.rzname" placeholder="请输入姓名" clearable style="width: 200px;position: relative;right: 105px;" />
    <el-select v-model="data.rzsexxx"  @change="mohuchaxunyghmdddd" style="position: relative;right: 10px;"  placeholder="性别" clearable >
      <el-option label="男"  value="男" />
      <el-option label="女"   value="女" />

    </el-select>
    <span>部门:</span> <el-select   placeholder="部门"  v-model="data.bbbmmm"  @change="bumenchauxnlz" clearable>
...
<!--      <el-table-column prop="rzhyzk" label="婚姻状况" />-->
      ...
      <el-table-column  label="员工状态" >
        <template #default="scope">
          <span v-if="scope.row.ygzt==4">离职员工</span>
        </template>
      </el-table-column>
  ...
  <el-dialog v-model="dialogFormVisible3" title="编辑员工信息" :modal="data.cx2">
    ...
    <template #footer>
			<span class="dialog-footer">
				...
				<el-button type="primary" @click="dialogFormVisible3 = false,open2(),xiugai2(cx2)">确定</el-button>
			</span>
