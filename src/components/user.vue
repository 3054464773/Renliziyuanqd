...
<template >
  ...
  <div>
    ...
    <el-date-picker
        ...
        clearable
    />
    <el-button style="position: relative;right: -166px;" @click="mohuchaxunyghmddd">查询</el-button>
    <el-input v-model="data.rzname" placeholder="请输入姓名" clearable style="width: 200px;position: relative;right: 105px;" />
    <el-select v-model="data.rzsexxx"  @change="mohuchaxunyghmddd" style="position: relative;right: 10px;" placeholder="性别" clearable  >
...
<!--      <el-table-column prop="rzhyzk" label="婚姻状况" />-->
      ...
      <el-table-column  label="员工状态" >
        <template #default="scope">
          <span v-if="scope.row.ygzt==5">黑名单</span>
        </template>
      </el-table-column>
...
<!--          &lt;!&ndash; 删除 &ndash;&gt;delUser(scope.row.ybh),-->
