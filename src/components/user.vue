...
<template >
  ...
  <div>
    ...
    <el-button style="position: relative;right: -166px;" @click="b(data.users.ybh)" >查询</el-button>
    <el-input v-model="data.users.ybh"   placeholder="请输入员工编号" clearable style="width: 220px;position: relative;right: 125px;" />
    ...
    <el-table v-bind:data="data.users" style="width: 100%" height="400">
      ...
      <el-table-column  label="操作" >
        <template #default=scope v-slot="scope">
          <!-- 删除 -->
          <el-button type="primary" :icon="Delete" plain @click="delUser(scope.row.ybh),open1()" />
  ...
  <el-dialog v-model="dialogFormVisible" title="修改员工信息">
    ...
    <template #footer>
			<span class="dialog-footer">
				...
				<el-button type="primary" @click="dialogFormVisible = false,xiugai(data.cx),open()">确定</el-button>
			</span>
