<template>
  ...
  <el-table :data="data.Recruit" height="350" style="width: 100%">
    ...
    <el-table-column prop="rzname" label="被面试人"  />
    <el-table-column prop="rzbh" label="简历编号"  />
    <el-table-column prop="rsj" label="面试日期"  />
    <el-table-column prop="rzt" label="状态"  />
    <el-table-column label="操作" >
      <template #default=scope v-slot="scope">
        <el-button size="20px"  @click="reload()">录用</el-button>	<!-- 删除 -->
        <el-button size="20px"  type="success" plain @click="dialogFormVisible=true,a(scope.row.rzbh)">查看</el-button>	<!-- 查看 -->
      </template>
  ...
  <el-dialog v-model="dialogFormVisible" title="查看员工信息" >
    ...
    <template #footer>
	  	<span class="dialog-footer">
	  		...
	  		<el-button type="primary" @click="dialogFormVisible = false,reload()">确定</el-button>
	  	</span>
